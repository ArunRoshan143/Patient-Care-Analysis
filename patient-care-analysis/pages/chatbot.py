...
def generate_questions(inp): 
    ...
    if not inp:
        if dis and name:
            ...
            you are a mental health chatbot,give a intro about yourself your name is baymax and say that users can ask any question abut their mentalhealth or their deisese, answer every thing in 3 lines not more than taht talk like a friend who is very conserned about , you will let the user speak out  their heart and answer them with care, use polite words and handle  with care ,if the user says something that is no 
            ...
            prompt=f"Hi {st.session_state.user_name}, I am medBot, How can I help you?"
            return prompt
    else:
        prompt=inp
